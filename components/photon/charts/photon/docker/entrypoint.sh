...
if [ ! -d "/photon/photon_data/elasticsearch" ]; then
    ...
    wget --user-agent="$USER_AGENT" -O - https://download1.graphhopper.com/public/extracts/by-country-code/al/photon-db-al-latest.tar.bz2 | bzip2 -cd | tar x
fi
